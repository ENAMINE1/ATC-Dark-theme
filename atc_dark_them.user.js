...
(function() {
  ...
  const editorFontSize = "16pt";

const base03  = "#1e1e1e"; // Background
const base02  = "#252526"; // Lighter background
const base01  = "#3c3c3c"; // Selection background
const base00  = "#dcdcdc"; // Comments
const base0   = "#d4d4d4"; // Foreground
const base1   = "#e5e5e5"; // Lighter foreground
const base2   = "#f3f3f3"; // Light background
const base3   = "#ffffff"; // White
const yellow  = "#dcdcaa"; // Keywords
const orange  = "#ce9178"; // Strings
const red     = "#f44747"; // Errors
const magenta = "#c586c0"; // Constants
const violet  = "#b4009e"; // Special keywords
const blue    = "#569cd6"; // Functions
const cyan    = "#4ec9b0"; // Types
